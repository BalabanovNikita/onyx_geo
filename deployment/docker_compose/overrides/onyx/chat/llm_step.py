            ...
            if tool_calls and isinstance(tool_calls, list):
                ...
                for tool_call in tool_calls:
                    if isinstance(tool_call, dict):
                        ...
                        tool_call_json = json.dumps(tool_call_dict, indent=4, ensure_ascii=False)
...
def run_llm_step(
            ...
            tool_calls_list: list[ToolCall] = [
                {
                    ...
                    "function": {
                        ...
                        "arguments": json.dumps(kickoff.tool_args, ensure_ascii=False),
                    },
                }
    ...
    if tool_calls:
        tool_calls_str = "\n".join(
            f"  - {tc.tool_name}: {json.dumps(tc.tool_args, indent=4, ensure_ascii=False)}"
